...
using AAS.LiveApp.WebClient.ViewModels;
using AAS.LiveApp.WebClient.Helpers;
using AAS.LiveApp.WebClient.Authorization;
...
namespace AAS.LiveApp.WebClient
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("AAS.LiveApp.WebClient"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "AAS.LiveApp.WebClient API", Version = "v1" });
